...
import { AddDailyCollection, AddDailyExpense } from '../../Api/Api';
...
const Addcollection = ({navigation}) => {
    ...
    const handleAddExpense = async () => {
        ...
        try {
            ...
            const response = await AddDailyCollection(formattedDate, paidTo, amount, notes, file);
            ...
            if (typeof response === 'object' && response !== null) {
                ...
                navigation.replace('Daily Collection'); 
            } else {
                Toast.show({
